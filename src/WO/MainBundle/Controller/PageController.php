...
use WO\MainBundle\Entity\Page;
use WO\MainBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WOMainBundle:Page')->findAll();
     ...
     * @Method("POST")
     * @Template("WOMainBundle:Page:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WOMainBundle:Page')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WOMainBundle:Page:edit.html.twig")
     */
