...
use WO\MainBundle\Entity\Service;
use WO\MainBundle\Form\ServiceType;
...
class ServiceController extends Controller
{
     ...
     * @Method("POST")
     * @Template("WOMainBundle:Service:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WOMainBundle:Service')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WOMainBundle:Service:edit.html.twig")
     */
