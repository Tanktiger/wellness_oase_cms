...
use WO\OrganizerBundle\Entity\Location;
use WO\OrganizerBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WOOrganizerBundle:Location')->findAll();
     ...
     *
     * @Route("/", name="organizer_location_create")
     * @Method("POST")
     * @Template("WOOrganizerBundle:Location:new.html.twig")
     */
     ...
     *
     * @Route("/new", name="organizer_location_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="organizer_location_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WOOrganizerBundle:Location')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="organizer_location_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="organizer_location_update")
     * @Method("PUT")
     * @Template("WOOrganizerBundle:Location:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}", name="organizer_location_delete")
     * @Method("DELETE")
     */
